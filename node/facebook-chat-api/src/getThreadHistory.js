  ...
  switch (attachment.__typename) {
    ...
    case "MessageAnimatedImage":
      return {
        ...
        url: (typeof blob == 'undefined' ? undefined : blob.animated_image.uri),
        width: (typeof blob == 'undefined' ? undefined : blob.animated_image.width),
        height: (typeof blob == 'undefined' ? undefined : blob.animated_image.height),

        thumbnailUrl: (typeof blob == 'undefined' ? undefined : blob.preview_image.uri), // @Legacy
        name: attachment.filename, // @Legacy
        facebookUrl: attachment.animated_image.uri, // @Legacy
        rawGifImage: (typeof blob == 'undefined' ? undefined : blob.animated_image.uri), // @Legacy
        animatedGifUrl: (typeof blob == 'undefined' ? undefined : blob.animated_image.uri), // @Legacy
        animatedGifPreviewUrl: (typeof blob == 'undefined' ? undefined : blob.preview_image.uri), // @Legacy
        animatedWebpUrl: (typeof blob == 'undefined' ? undefined : blob.animated_image.uri), // @Legacy
        animatedWebpPreviewUrl: (typeof blob == 'undefined' ? undefined : blob.preview_image.uri), // @Legacy
    ...
    case "MessageVideo":
      return {
        ...
        thumbnailUrl: (typeof blob == 'undefined' ? undefined : blob.large_image.uri), // @Legacy
